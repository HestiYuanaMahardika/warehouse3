                    ...
                    <div id="form" class="card">
                        <div class="card-body">
                            <form role="form" id="stock-update" method="post">
                                ...
                                <div id="lokasi" class="form-group row">
                                ...
                                <div id="project" class="form-group row">
                                    <label for="project" class="col-sm-4 col-form-label">Proyek</label>
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" id="proyek" name="proyek">
                                        </select>
                                    </div>
                                </div>
                                <div id="date" class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group date" id="stock_date" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input stock_date_text" id="stock_date_text" name="stock_date" data-target="#stock_date"/>
    ...
    <script>
        ...
        function getProyek(pid=null){
            ...
            $.ajax({
                ...
                success:function(data) {
                    $('#proyek').empty();
                    $('#proyek').append('<option value="">.:: Select Proyek ::.</option>');
                    $.each(data, function(key, value) {
                        if(type == 0){
                            $('#proyek').append('<option value="'+ value.proyek_id +'">'+ value.proyek_name +' (Stock: '+value.product_amount+')</option>');
                        } else {
                            $('#proyek').append('<option value="'+ value.proyek_id +'">'+ value.proyek_name +'</option>');
                        }
                    });
                }
            });
