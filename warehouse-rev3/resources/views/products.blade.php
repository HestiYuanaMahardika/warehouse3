                        ...
                        @if(count($products) > 0)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button title="Lihat Barcode" type="button" code="{{ $d->product_code }}" class="btn-lihat btn btn-info btn-xs" data-toggle="modal" data-target="#lihat-barcode" onclick="barcode({{ $d->product_code }})"><i class="fas fa-barcode"></i></button> @if(Auth::user()->role == 0)
